...
public final class ProjectCodeBuilder {
    ...
    public static void generateModuleCode(
        ...
        EventReciever dependencyEventReciever =
                new EventReciever() {
                    ...
                    public void onArtifactNotFound(Artifact artifact) {
                        if (listener != null) {
                            ProjectCodeBuildException artifactNotFound =
                                    new ProjectCodeBuildException();
                    ...
                    public void onDependenciesNotFound(Artifact artifact) {
                        ProjectCodeBuildException dependecyNotFound =
                                new ProjectCodeBuildException();
        ...
        try (ProjectConnection connection =
                GradleConnector.newConnector()
                        ...
                        .connect()) {
            connection.newBuild().forTasks("tasks").setStandardOutput(System.out).run();
        }
